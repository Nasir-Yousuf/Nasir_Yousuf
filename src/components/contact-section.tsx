...
export function ContactSection() {
  return (
    <section id="contact" className="py-24 relative overflow-hidden">
      {/* Decorative Elements */}
      <motion.div 
        className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/3 w-[500px] h-[500px] bg-primary/10 rounded-full blur-3xl -z-10"
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
                  <Link
                    ...
                    className={buttonVariants({
                      size: "lg",
                      className: "w-full rounded-full h-14 px-8 text-base",
                    })}
                  >
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
                  <Link
                    ...
                    className={buttonVariants({
                      variant: "outline",
                      size: "lg",
                      className: "w-full rounded-full h-14 px-8 text-base bg-background/50 hover:bg-green-500/10 hover:text-green-600 hover:border-green-500/50 transition-colors",
                    })}
                  >
